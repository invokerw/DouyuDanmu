...
void dy_barrage_client::on_barrage(string data)
{
	...
	// system("chcp 936");
	//string str33(barr_res.content.rbegin(),barr_res.content.rend());  
	//cout<<"转换之后："<<str33<<endl;
	cout << UTF8ToANSI(barr_res.sender_name.c_str()) << ": " << UTF8ToANSI(barr_res.content.c_str()) << endl;
}
